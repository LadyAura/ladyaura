(function () {
  ...
  function addStyles() {
    ...
    style.textContent = [
      ...
      '.site-header .nav-icon-dot{display:inline-block!important;width:.72em!important;height:.72em!important;min-width:.72em!important;border-radius:50%!important;background:linear-gradient(135deg,var(--nav-dot-a,#e8c97a),var(--nav-dot-b,#a03fff))!important;box-shadow:0 0 0 3px color-mix(in srgb,var(--nav-dot-a,#e8c97a) 20%,transparent),0 0 13px color-mix(in srgb,var(--nav-dot-b,#a03fff) 60%,transparent)!important;vertical-align:-.04em!important}',
      '.site-header .nav-icon-home{--nav-dot-a:#fff1a8;--nav-dot-b:#e8c97a}.site-header .nav-icon-zodiac{--nav-dot-a:#86e7ff;--nav-dot-b:#a03fff}.site-header .nav-icon-aura{--nav-dot-a:#f4d9ff;--nav-dot-b:#ff7bd5}.site-header .nav-icon-nedeka{--nav-dot-a:#ffd98a;--nav-dot-b:#2dd4bf}.site-header .nav-icon-maika{--nav-dot-a:#ffb7d8;--nav-dot-b:#8b5cf6}.site-header .nav-icon-custom{--nav-dot-a:#c7f9ff;--nav-dot-b:#f59e0b}.site-header .nav-icon-orders{--nav-dot-a:#d8b4fe;--nav-dot-b:#60a5fa}.site-header .nav-icon-cart{--nav-dot-a:#a7f3d0;--nav-dot-b:#22c55e}',
      ...
      '.flag-en,.flag-gb{background:repeating-linear-gradient(180deg,#b22234 0 7.7%,#fff 7.7% 15.4%)!important}',
      '.flag-en:before,.flag-gb:before{content:""!important;position:absolute!important;left:0!important;top:0!important;width:43%!important;height:54%!important;background:#3c3b6e!important;border-radius:2px 0 2px 0!important;box-shadow:inset 2px 2px 0 -1px rgba(255,255,255,.95),inset 6px 2px 0 -1px rgba(255,255,255,.95),inset 10px 2px 0 -1px rgba(255,255,255,.95),inset 2px 5px 0 -1px rgba(255,255,255,.95),inset 6px 5px 0 -1px rgba(255,255,255,.95),inset 10px 5px 0 -1px rgba(255,255,255,.95)!important}',
  ...
  function normalizeHeader() {
    ...
    var links = [
      ['index.html', '<span class="nav-icon-dot nav-icon-home" aria-hidden="true"></span>Inicio'],
      ['horoscopo.html', '<span class="nav-icon-dot nav-icon-zodiac" aria-hidden="true"></span>Horoscopo'],
      ['especiales.html', '<span class="nav-icon-dot nav-icon-aura" aria-hidden="true"></span>AURA'],
      ['nedeka.html', '<span class="nav-icon-dot nav-icon-nedeka" aria-hidden="true"></span>NEDEKA'],
      ['maika.html', '<span class="nav-icon-dot nav-icon-maika" aria-hidden="true"></span>MAIKA'],
      ['circulo-aura.html', '<span class="red-circle-dot" aria-hidden="true"></span>CIRCULO AURA'],
      ['personalizados.html', '<span class="nav-icon-dot nav-icon-custom" aria-hidden="true"></span>Personalizados'],
      ['pedidos.html', '<span class="nav-icon-dot nav-icon-orders" aria-hidden="true"></span>Mis pedidos']
    ];
    ...
    header.innerHTML = [
      ...
      '<div class="lady-aura-header-actions" aria-label="Carrito e idioma"><a href="carrito.html" class="cart-nav-link" aria-label="Ver carrito"' + cartActive + ' style="position:relative;display:inline-flex;align-items:center;text-decoration:none;"><span class="nav-icon-dot nav-icon-cart" aria-hidden="true"></span>Carrito<span class="cart-badge" style="display:none">0</span></a></div>'
    ].join('');
